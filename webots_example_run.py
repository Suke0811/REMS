...
i = FileInput('out/sim08_30_2022_10_45_39.csv', loop=False)
#i = KeyboardInput()
#i = JoystickInput()
...
s.add_robot(CreateDef, WebotsBinder, (AnimationOutput('video/test'+time_str()+'.gif'), FileOutput('out/sim'+time_str()+'.yml')) )

...
#i = FileInput('trajectory/ref_robot.csv', loop=False)
#i = KeyboardInput()
#i = JoystickInput()
...
s.run(SimConfig(max_duration=100, dt=0.02, realtime=False, start_time=10, run_speed=2))  # run 10sec, at the end of run, automatically do outputs.

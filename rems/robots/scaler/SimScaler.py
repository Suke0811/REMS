...
from rems.robots.scaler.pybullet.scalar_sim import pyb_sim
from rems.typing.definitions import *
from rems.utils.urdf_relative_path import urdf_filepath_resolver
...
class SimScaler(RobotBase):
    ...
    def init(self, *args):
        ...
        self.my_sim = pyb_sim(urdf_filename=urdf_filename, bodyFixed=not self.mode.MOBILE, DoFnum=self.mode.DOF, delta_t=self.run.DT)

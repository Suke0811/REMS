...
class GroupSyncRead:
    ...
    def txRxPacket(self):
        # Seems like writing once and reading multiple times will cause error. Have to write and then read
        if self.ph.getProtocolVersion() == 1.0:
            return COMM_NOT_AVAILABLE
    ...
    def getData(self, dxl_id, address, data_length):
        ...
        if data_length == 1:
            ...
            return [DXL_MAKEDWORD(DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 0],
                    ...
                    DXL_MAKEDWORD(DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 4],
